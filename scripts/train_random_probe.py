...
def build_random_probe_model(cfg: dict, device: str) -> RandomProbeSolver:
...
def main():
    ...
    parser.add_argument("--save", type=str, default="artifacts/random_probe_last.pt")
    ...
    model = build_random_probe_model(cfg, device)
    ...
    print(f"Saved random-probe checkpoint to {save_path}")
